...
use Piggly\ValueTypes\Advanced\CountryCodeType;

/**
 * @coversDefaultClass \Piggly\ValueTypes\Advanced\CountryCodeType
 */
class CountryCodeTypeTest extends TestCase
{
	...
	{ $this->assertEquals($expected, (new CountryCodeType($value))->validate()); }
