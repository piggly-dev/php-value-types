...
use Piggly\ValueTypes\Advanced\CurrencyCodeType;

/**
 * @coversDefaultClass \Piggly\ValueTypes\Advanced\CurrencyCodeType
 */
class CurrencyCodeTypeTest extends TestCase
{
	...
	{ $this->assertEquals($expected, (new CurrencyCodeType($value))->validate()); }
